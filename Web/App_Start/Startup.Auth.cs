...
namespace Considerate.Hellolingo.WebApp
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(()=> new HellolingoEntities());
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                {
					// Bernard: I once commented out this block, and it didn't seem to change anything
				...
				,ExpireTimeSpan = TimeSpan.FromDays(365) // Default is 14
				//,SlidingExpiration = false			 // Default is true, and it's better like this
